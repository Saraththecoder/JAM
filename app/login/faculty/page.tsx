    ...
    try {
      ...
      if (data?.user) {
        ...
        if (profile.role !== 'faculty') {
          ...
          throw new Error('Access denied. This portal is for faculty only. Students must use the Student Portal.');
        }
    ...
    <div className="min-h-screen bg-transparent text-[#1c1a17] flex flex-col justify-center py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-sm mx-auto z-10">
        ...
        <div className="text-center mb-6">
          <h1 className="text-2xl font-serif font-black tracking-tight text-black">Faculty Sign In</h1>
          <p className="mt-1.5 text-xs font-bold text-zinc-500">
            Use your university-issued faculty email and password.
          </p>
        </div>
        ...
        <div className="paper-card py-7 px-5 sm:px-8 rounded-2xl">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  placeholder="name@aits-tpt.edu.in"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  placeholder="••••••••"
                  className="block w-full pl-9 pr-3 py-2.5 bg-neuyellow text-black placeholder-black/50 border-2 border-black font-bold focus:shadow-[3px_3px_0px_rgba(0,0,0,1)] transition-all rounded-xl text-sm"
                />
              </div>
            </div>
          ...
          <div className="mt-5 pt-5 border-t-2 border-black text-center text-xs text-zinc-500 font-semibold">
            <p>
              ...
              <Link href="/login/student" className="font-bold underline text-black hover:text-neured transition-colors">
                Go to Student Login →
              </Link>
            </p>
          </div>
        ...
        <p className="text-center text-xs text-zinc-500 font-bold mt-4">
          Faculty accounts are provisioned by the department HOD.
        </p>
      </div>
    </div>
  );
